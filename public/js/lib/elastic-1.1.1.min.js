...
!function () {
    ...
    E = "undefined" != typeof exports ? exports : F.ejs = {}, a = function (a, b) {
        ...
        return b[a] = {geo_distance: {location: c._self(), ranges: []}}, {
            field: function (c) {
                ...
                return 0 === arguments.length ? b[a].geo_distance.ranges : (b[a].geo_distance.ranges.push({
                    from: c,
                    to: d
                }), this)
        ...
        return b.geo_distance_range[a] = [0, 0], {
            field: function (c) {
        ...
        return {
            index: function (b) {
                ...
                return null == a ? d.percolate : (d.percolate = a, this)
            }, opType: function (a) {
        ...
        var c = {common: {}};
        return null == a && (a = "no_field_set"), c.common[a] = {}, null != b && (c.common[a].query = b), {
            field: function (b) {
                var d = c.common[a];
        ...
        return null != b && (c.filtered.filter = b._self()), {
            query: function (a) {
        ...
        var c = {flt_field: {}};
        return c.flt_field[a] = {like_text: b}, {
            field: function (b) {
                var d = c.flt_field[a];
        ...
        var c = {mlt_field: {}};
        return c.mlt_field[a] = {like_text: b}, {
            field: function (b) {
                var d = c.mlt_field[a];
        ...
        return null != a && (b.span_multi.match = a._self()), {
            match: function (a) {
        ...
        var c = [0, 0];
        return null != b && g(b) && 2 === b.length && (c = [b[1], b[0]]), {
            properties: function (b) {
                return null == b ? c : (h(b) && a(b, "lat") && a(b, "lon") && (c = {lat: b.lat, lon: b.lon}), this)
            }, string: function (a) {
        ...
        return c = [], b = b || {}, d = null == b.indices ? [] : i(b.indices) ? [b.indices] : b.indices, e = null == b.types ? [] : i(b.types) ? [b.types] : b.types, 0 === d.length && e.length > 0 && (d = ["_all"]), {
            requests: function (a) {
                if (null == a)return c;
        ...
        return d = {}, b = b || {}, e = null == b.indices ? [] : i(b.indices) ? [b.indices] : b.indices, f = null == b.types ? [] : i(b.types) ? [b.types] : b.types, 0 === e.length && f.length > 0 && (e = ["_all"]), null != b.routing && (h.routing = b.routing), {
            sort: function () {
                var b, c;
        ...
        var c = {query: {}};
        return null != a && (c.window_size = a), null != b && (c.query.rescore_query = b._self()), {
            rescoreQuery: function (a) {
        ...
        return a = a.toLowerCase(), d(a) && (c.type = a, c.coordinates = b), {
            type: function (a) {
        ...
        return b[a] = {phrase: {}}, {
            text: function (c) {
                ...
                return 0 === arguments.length ? b[a].phrase.smoothing : (b[a].phrase.smoothing = {
                    linear: {
                        trigram_lambda: c,
                        bigram_lambda: d,
                        unigram_lambda: e
